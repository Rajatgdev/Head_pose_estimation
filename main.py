...
facemesh = face_mesh.FaceMesh(min_detection_confidence=0.5,
                              min_tracking_confidence=0.5)  # Setting up the detection rate
    ...
    if result.multi_face_landmarks:  # Multiple face Landmarks
        for face_landmarks in result.multi_face_landmarks:
            ...
            success, rot_vec, trans_vec = cv2.solvePnP(face_3d, face_2d, cam_matrix,
                                                       dist_matrix)  # rot_vec for point has rotated
